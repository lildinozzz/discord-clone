...
export const ChatItem = ({
  ...
  const onOpenDeleteMessageModal = () => {
  ...
  return (
    <div className="relative group flex items-center hover:bg-black/5 p-4 transition w-full ">
      ...
      {canDeleteMessage && (
        <div className="hidden group-hover:flex items-center gap-x-2 absolute p-1 -top-2 right-5 bg-white dark:bg-zinc-600 border rounded-sm">
          {canEditMessage && (
          ...
          <ActionTooltip label="Delete">
            <Trash
              onClick={onOpenDeleteMessageModal}
              className="w-4 h-4 cursor-pointer ml-auto text-zinc-500 hover:text-zinc-600 dark:hover:text-zinc-300 transition"
            />
          </ActionTooltip>
        </div>
